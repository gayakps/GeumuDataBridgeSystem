...
public class ShortNBT extends NumberNBT {
   ...
   public static ShortNBT valueOf(short value) {
      return value >= -128 && value <= 1024 ? Cache.CACHE[value + 128] : new ShortNBT(value);
   }
   ...
   public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
      ...
      return (new StringTextComponent(String.valueOf((int)this.data))).appendSibling(itextcomponent).mergeStyle(SYNTAX_HIGHLIGHTING_NUMBER);
   }
