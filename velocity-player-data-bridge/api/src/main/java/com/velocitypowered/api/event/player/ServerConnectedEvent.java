...
public final class ServerConnectedEvent {
  ...
  public ServerConnectedEvent(Player player, RegisteredServer server,
    ...
    if ( previousServer == null ) {
      System.out.printf("[ServerConnectedEvent] Player : %s %s\n", player.getUsername(), server.getServerInfo().getName());
    } else {
      System.out.printf("[ServerConnectedEvent] Player : %s %s->%s\n", player.getUsername(), previousServer.getServerInfo().getName(), server.getServerInfo().getName());
    }
  }
