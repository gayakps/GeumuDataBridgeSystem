...
public class ServerPostConnectEvent {
  ...
  public ServerPostConnectEvent(Player player,
    ...
    if ( previousServer != null ) {
      System.out.printf("[ServerPostConnectEvent] Player : %s previousServer : %s\n", player.getUsername(), previousServer.getServerInfo().getName());
    } else {
      System.out.printf("[ServerPostConnectEvent] Player : %s New Connection\n", player.getUsername());
    }
